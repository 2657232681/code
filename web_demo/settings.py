...
SECRET_KEY = 'django-insecure--w7lsy(x%5fx%is)z00rt7b+2uk^a-2zm4n+))dk-3xiau#rkr'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "app.context_processors.global_defaults"
            ],
        },
    },
]
...
ASGI_APPLICATION = 'web_demo.asgi.application'
